...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-800 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-12 mb-20">
          <div className="col-span-2 lg:col-span-4">
            <div className="flex items-center gap-2 mb-8">
              <div className="w-10 h-10 gradient-primary rounded-xl flex items-center justify-center text-white font-black text-xl shadow-lg shadow-blue-500/20">
                G
              </div>
              <span className="text-2xl font-black text-white tracking-tight">GeoRankers</span>
            </div>
            <p className="text-slate-300 text-lg leading-relaxed max-w-sm mb-10 font-medium">
              The world's first visibility intelligence platform built specifically for the AI discovery era.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-all border border-white/5">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm font-bold">
              <li><a href="#" className="text-slate-400 hover:text-blue-400 transition-colors">Platform</a></li>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm font-bold">
              ...
              <li><a href="#" className="text-slate-400 hover:text-blue-400 transition-colors">AI Search Guide</a></li>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs font-bold text-slate-500">© {new Date().getFullYear()} GeoRankers Inc. All rights reserved.</p>
          <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/5">
            ...
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Global Intelligence Infrastructure Operational</span>
          </div>
        </div>
      </div>
    </footer>
